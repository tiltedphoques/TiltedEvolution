...
ClientOpcode ClientMessage::GetOpcode() const noexcept { return m_opcode; }
...
void ClientMessage::SerializeRaw(TiltedPhoques::Buffer::Writer& aWriter) const noexcept { aWriter.WriteBits(m_opcode, sizeof(m_opcode) * 8); }
...
ServerOpcode ServerMessage::GetOpcode() const noexcept { return m_opcode; }
...
void ServerMessage::SerializeRaw(TiltedPhoques::Buffer::Writer& aWriter) const noexcept { aWriter.WriteBits(m_opcode, sizeof(m_opcode) * 8); }
