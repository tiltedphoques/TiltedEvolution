...
void Container::EffectItem::Serialize(TiltedPhoques::Buffer::Writer& aWriter) const noexcept
{
...
void Container::EffectItem::Deserialize(TiltedPhoques::Buffer::Reader& aReader) noexcept
{
