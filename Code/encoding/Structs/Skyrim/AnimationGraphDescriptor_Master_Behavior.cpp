...
AnimationGraphDescriptor_Master_Behavior::AnimationGraphDescriptor_Master_Behavior()
{
    AnimationGraphDescriptorManager::Builder s_builder("Master_Behavior",
        AnimationGraphDescriptor{{129, 41,  205, 186, 130, 120, 76,  67,  68,  52,  21,  25,  51,  70,  71,  72,
                                  ...
                                  kNotCasting, kiMagicEquipped, kPitchOverride},
                                 {kDirection, kSpeedSampled, kweapAdj, kSpeed, kCastBlendDamped, kCastBlend, kSpeedDamped},
                                 {kTurnDelta, kiRightHandEquipped, kiLeftHandEquipped, ki1HMState, kiState,
                                  kiLeftHandType, kiRightHandType, ktestint, kcurrentDefaultState}});
}
