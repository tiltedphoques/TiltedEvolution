...
void* EquipManager::Equip(Actor* apActor, TESForm* apItem, BSExtraDataList* apExtraDataList, int aCount, void* aSlot, bool aUnk1, bool aPreventEquip, bool aUnk2, bool aUnk3)
{
    ...
    POINTER_SKYRIMSE(TEquipInternal, s_equipFunc, 0x14065D710 - 0x140000000);
...
void* EquipManager::UnEquip(Actor* apActor, TESForm* apItem, BSExtraDataList* apExtraDataList, int aCount, void* aSlot, int aUnk1, bool aPreventEquip, bool aUnk2, bool aUnk3, void* aUnk4)
{
    ...
    POINTER_SKYRIMSE(TUnEquipInternal, s_unequipFunc, 0x14065DF00 - 0x140000000);
...
static TiltedPhoques::Initializer s_equipmentHooks([]()
    {
        POINTER_SKYRIMSE(TEquip, s_equipFunc, 0x14065FD20 - 0x140000000);
        POINTER_SKYRIMSE(TUnEquip, s_unequipFunc, 0x140660700 - 0x140000000);
        POINTER_SKYRIMSE(TEquipSpell, s_equipSpellFunc, 0x14065F9C0 - 0x140000000);
        POINTER_SKYRIMSE(TUnEquipSpell, s_unequipSpellFunc, 0x14065E130 - 0x140000000);
        POINTER_SKYRIMSE(TEquipShout, s_equipShoutFunc, 0x14065F9C0 - 0x140000000);
        POINTER_SKYRIMSE(TUnEquipShout, s_unequipShoutFunc, 0x140660410 - 0x140000000);
