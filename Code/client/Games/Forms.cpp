...
TESForm* TESForm::GetById(const uint32_t aId)
{
    ...
    POINTER_SKYRIMSE(TGetFormById, getFormById, 0x14019F080 - 0x140000000);
...
uint32_t TESForm::GetChangeFlags() const noexcept
{
    ...
    POINTER_SKYRIMSE(InternalGetChangeFlags, internalGetChangeFlags, 0x140598800 - 0x140000000);
