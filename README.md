...
Skyrim Together  is a framework created to enable multiplayer in Bethesda games, currently supporting **Skyrim Special Edition** and eventually **Fallout 4**.

## Getting started
To play Skyrim Together, grab the latest released binaries from the [releases page](https://github.com/tiltedphoques/TiltedOnline/releases).
...
Skyrim Together is written by multiple independant parties. The copyright of a contribution is held by the contributing party.
